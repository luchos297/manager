...
public class ManagerController {
	...
	@GetMapping
	@Operation(summary = API_OPERATION_VALUE_OLP, description = API_OPERATION_NOTES_OLP, tags = {API_MANAGER_TAG})
	@ApiResponses(value = {
	...
	@Operation(summary = API_OPERATION_VALUE_OLPT, description = API_OPERATION_NOTES_OLPT, tags = {API_MANAGER_TAG})
	@ApiResponses(value = {
